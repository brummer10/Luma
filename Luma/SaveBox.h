...
/****************************************************************
        SaveBox - generate a text entry window 
...
****************************************************************/
    ...
    Widget_t *showSaveBox(Widget_t * w, const char* title, const char* message) {
        Widget_t *wid = create_window(w->app, os_get_root_window(w->app, IS_WINDOW), 0, 0,280, 70);
        set_widget_color(wid, (Color_state)0, (Color_mod)1, 0.145f, 0.153f, 0.169f, 1.0f);
        wid->label = message;
